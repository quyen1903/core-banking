package com.quinnbank.core.cif.infrastructure.generator;
...
public class SystemClockCustomerNumberGenerator implements CustomerNumberGeneratorPort {
    private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("yyyyMMddHHmmssSSS").withZone(ZoneOffset.UTC);
    private final Clock clock;

    public SystemClockCustomerNumberGenerator(Clock clock) {
        this.clock = clock;
    }
